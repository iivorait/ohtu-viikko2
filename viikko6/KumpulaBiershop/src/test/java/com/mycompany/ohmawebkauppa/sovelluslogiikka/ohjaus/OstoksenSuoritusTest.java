...
import com.mycompany.webkauppa.ohjaus.KomentotehdasTesteille;
...
public class OstoksenSuoritusTest {
    ...
    KomentotehdasTesteille komennot;
    ...
    public void setUp() {
        ...
        komennot = new KomentotehdasTesteille();
        komennot.korvaaVarastonTietokantaMuistilla(varasto);
    }
    
    @Test
    public void josMaksuOnnistuuKoriTyhjenee() {
        ostoksenSuoritus = komennot.ostoksenSuoritus(nimi, osoite, luottokortti, kori, varasto, pankki);
    ...
    public void josPankkiEiHyvaksyMaksuaPalautetaanFalseToimitustaEiTehda() {        
        ostoksenSuoritus = komennot.ostoksenSuoritus(nimi, osoite, luottokortti, kori, varasto, hylkaavaPankki);
